...
def attack(char_name: str,
           char_class: str) -> str:
    """Выдает урон в зависимости от класса."""
...
def defence(char_name: str,
            char_class: str) -> str:
    """Вычисляет уровень блокировки урона в зависимости от класса."""
    if char_class == 'warrior':
...
def special(char_name: str,
            char_class: str) -> str:
    """В зависимости от типа персонажа возвращает.
    сообщение о преминение специального умения."""
    if char_class == 'warrior':
